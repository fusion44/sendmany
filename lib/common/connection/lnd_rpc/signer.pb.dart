...
class KeyLocator extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('KeyLocator', package: const $pb.PackageName('signrpc'), createEmptyInstance: create)
...
class KeyDescriptor extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('KeyDescriptor', package: const $pb.PackageName('signrpc'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, 'rawKeyBytes', $pb.PbFieldType.OY)
    ..a<KeyLocator>(2, 'keyLoc', $pb.PbFieldType.OM, defaultOrMaker: KeyLocator.getDefault, subBuilder: KeyLocator.create)
    ..hasRequiredFields = false
  ;
...
class TxOut extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TxOut', package: const $pb.PackageName('signrpc'), createEmptyInstance: create)
    ..aInt64(1, 'value')
  ...
  TxOut copyWith(void Function(TxOut) updates) => super.copyWith((message) => updates(message as TxOut));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SignDescriptor extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SignDescriptor', package: const $pb.PackageName('signrpc'), createEmptyInstance: create)
    ..a<KeyDescriptor>(1, 'keyDesc', $pb.PbFieldType.OM, defaultOrMaker: KeyDescriptor.getDefault, subBuilder: KeyDescriptor.create)
    ...
    ..a<TxOut>(5, 'output', $pb.PbFieldType.OM, defaultOrMaker: TxOut.getDefault, subBuilder: TxOut.create)
  ...
  SignDescriptor copyWith(void Function(SignDescriptor) updates) => super.copyWith((message) => updates(message as SignDescriptor));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SignReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SignReq', package: const $pb.PackageName('signrpc'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, 'rawTxBytes', $pb.PbFieldType.OY)
    ..pc<SignDescriptor>(2, 'signDescs', $pb.PbFieldType.PM, subBuilder: SignDescriptor.create)
    ..hasRequiredFields = false
  ;
  ...
  SignReq copyWith(void Function(SignReq) updates) => super.copyWith((message) => updates(message as SignReq));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SignResp extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SignResp', package: const $pb.PackageName('signrpc'), createEmptyInstance: create)
  ...
  SignResp copyWith(void Function(SignResp) updates) => super.copyWith((message) => updates(message as SignResp));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InputScript extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('InputScript', package: const $pb.PackageName('signrpc'), createEmptyInstance: create)
  ...
  InputScript copyWith(void Function(InputScript) updates) => super.copyWith((message) => updates(message as InputScript));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InputScriptResp extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('InputScriptResp', package: const $pb.PackageName('signrpc'), createEmptyInstance: create)
    ..pc<InputScript>(1, 'inputScripts', $pb.PbFieldType.PM, subBuilder: InputScript.create)
    ..hasRequiredFields = false
  ;
  ...
  InputScriptResp copyWith(void Function(InputScriptResp) updates) => super.copyWith((message) => updates(message as InputScriptResp));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static InputScriptResp getDefault() => _defaultInstance ??= create()..freeze();
...
class SignMessageReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SignMessageReq', package: const $pb.PackageName('signrpc'), createEmptyInstance: create)
  ...
  SignMessageReq copyWith(void Function(SignMessageReq) updates) => super.copyWith((message) => updates(message as SignMessageReq));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SignMessageResp extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SignMessageResp', package: const $pb.PackageName('signrpc'), createEmptyInstance: create)
  ...
  SignMessageResp copyWith(void Function(SignMessageResp) updates) => super.copyWith((message) => updates(message as SignMessageResp));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static SignMessageResp getDefault() => _defaultInstance ??= create()..freeze();
...
class VerifyMessageReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('VerifyMessageReq', package: const $pb.PackageName('signrpc'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, 'msg', $pb.PbFieldType.OY)
  ...
  VerifyMessageReq copyWith(void Function(VerifyMessageReq) updates) => super.copyWith((message) => updates(message as VerifyMessageReq));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static VerifyMessageReq getDefault() => _defaultInstance ??= create()..freeze();
...
class VerifyMessageResp extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('VerifyMessageResp', package: const $pb.PackageName('signrpc'), createEmptyInstance: create)
    ..aOB(1, 'valid')
    ..hasRequiredFields = false
  ;
  ...
  VerifyMessageResp copyWith(void Function(VerifyMessageResp) updates) => super.copyWith((message) => updates(message as VerifyMessageResp));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static VerifyMessageResp getDefault() => _defaultInstance ??= create()..freeze();

...
class PaymentState extends $pb.ProtobufEnum {
  ...
  static const PaymentState FAILED_TIMEOUT = PaymentState._(2, 'FAILED_TIMEOUT');
  static const PaymentState FAILED_NO_ROUTE = PaymentState._(3, 'FAILED_NO_ROUTE');
  static const PaymentState FAILED_ERROR = PaymentState._(4, 'FAILED_ERROR');
  static const PaymentState FAILED_INCORRECT_PAYMENT_DETAILS = PaymentState._(5, 'FAILED_INCORRECT_PAYMENT_DETAILS');
  static const PaymentState FAILED_INSUFFICIENT_BALANCE = PaymentState._(6, 'FAILED_INSUFFICIENT_BALANCE');

...
class SendPaymentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SendPaymentRequest',
    ...
    ..m<Int64, $core.List<$core.int>>(11, 'destTlv',
        entryClassName: 'SendPaymentRequest.DestTlvEntry',
  ...
  $core.bool get chatFree => $_get(15, false);
  set chatFree($core.bool v) {
    $_setBool(15, v);
  }

  $core.bool hasChatFree() => $_has(15);
  void clearChatFree() => clearField(998);

  $core.String get chatMessage => $_getS(16, '');
  set chatMessage($core.String v) {
    $_setString(16, v);
  }

  $core.bool hasChatMessage() => $_has(16);
  void clearChatMessage() => clearField(999);
}
...
class ReceiveChatMessagesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
  ...
  ReceiveChatMessagesRequest._() : super();
  factory ReceiveChatMessagesRequest() => create();
  factory ReceiveChatMessagesRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ReceiveChatMessagesRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ReceiveChatMessagesRequest clone() =>
      ReceiveChatMessagesRequest()..mergeFromMessage(this);
  ReceiveChatMessagesRequest copyWith(
          void Function(ReceiveChatMessagesRequest) updates) =>
      super.copyWith(
          (message) => updates(message as ReceiveChatMessagesRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ReceiveChatMessagesRequest create() => ReceiveChatMessagesRequest._();
  ReceiveChatMessagesRequest createEmptyInstance() => create();
  static $pb.PbList<ReceiveChatMessagesRequest> createRepeated() =>
      $pb.PbList<ReceiveChatMessagesRequest>();
  static ReceiveChatMessagesRequest getDefault() =>
      _defaultInstance ??= create()..freeze();
  static ReceiveChatMessagesRequest _defaultInstance;
}
...
class ChatMessage extends $pb.GeneratedMessage {
  ...
  Int64 get amtReceivedMsat => $_getI64(2);
  set amtReceivedMsat(Int64 v) {
    $_setInt64(2, v);
  }

  $core.bool hasAmtReceivedMsat() => $_has(2);
  void clearAmtReceivedMsat() => clearField(3);
}

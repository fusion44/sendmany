...
class SendPaymentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SendPaymentRequest', package: const $pb.PackageName('routerrpc'), createEmptyInstance: create)
    ...
    ..a<Int64>(8, 'outgoingChanId', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
    ..a<$core.int>(9, 'cltvLimit', $pb.PbFieldType.O3)
    ..pc<$0.RouteHint>(10, 'route_hints', $pb.PbFieldType.PM, subBuilder: $0.RouteHint.create)
    ..m<Int64, $core.List<$core.int>>(11, 'destCustomRecords', entryClassName: 'SendPaymentRequest.DestCustomRecordsEntry', keyFieldType: $pb.PbFieldType.OU6, valueFieldType: $pb.PbFieldType.OY, packageName: const $pb.PackageName('routerrpc'))
    ..aInt64(12, 'amtMsat')
  ...
  SendPaymentRequest copyWith(void Function(SendPaymentRequest) updates) => super.copyWith((message) => updates(message as SendPaymentRequest));
  ...
  static SendPaymentRequest getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set feeLimitMsat(Int64 v) { $_setInt64(12, v); }
...
class TrackPaymentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TrackPaymentRequest', package: const $pb.PackageName('routerrpc'), createEmptyInstance: create)
  ...
  TrackPaymentRequest copyWith(void Function(TrackPaymentRequest) updates) => super.copyWith((message) => updates(message as TrackPaymentRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static TrackPaymentRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class PaymentStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PaymentStatus', package: const $pb.PackageName('routerrpc'), createEmptyInstance: create)
    ..e<PaymentState>(1, 'state', $pb.PbFieldType.OE, defaultOrMaker: PaymentState.IN_FLIGHT, valueOf: PaymentState.valueOf, enumValues: PaymentState.values)
    ..a<$core.List<$core.int>>(2, 'preimage', $pb.PbFieldType.OY)
    ..a<$0.Route>(3, 'route', $pb.PbFieldType.OM, defaultOrMaker: $0.Route.getDefault, subBuilder: $0.Route.create)
    ..pc<$0.HTLCAttempt>(4, 'htlcs', $pb.PbFieldType.PM, subBuilder: $0.HTLCAttempt.create)
    ..hasRequiredFields = false
  ;
  ...
  PaymentStatus copyWith(void Function(PaymentStatus) updates) => super.copyWith((message) => updates(message as PaymentStatus));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  set route($0.Route v) { setField(3, v); }
...
class RouteFeeRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RouteFeeRequest', package: const $pb.PackageName('routerrpc'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, 'dest', $pb.PbFieldType.OY)
    ..aInt64(2, 'amtSat')
    ..hasRequiredFields = false
  ;
  ...
  RouteFeeRequest copyWith(void Function(RouteFeeRequest) updates) => super.copyWith((message) => updates(message as RouteFeeRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static RouteFeeRequest getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set amtSat(Int64 v) { $_setInt64(1, v); }
  $core.bool hasAmtSat() => $_has(1);
  void clearAmtSat() => clearField(2);
}

class RouteFeeResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RouteFeeResponse', package: const $pb.PackageName('routerrpc'), createEmptyInstance: create)
  ...
  RouteFeeResponse copyWith(void Function(RouteFeeResponse) updates) => super.copyWith((message) => updates(message as RouteFeeResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SendToRouteRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SendToRouteRequest', package: const $pb.PackageName('routerrpc'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, 'paymentHash', $pb.PbFieldType.OY)
    ..a<$0.Route>(2, 'route', $pb.PbFieldType.OM, defaultOrMaker: $0.Route.getDefault, subBuilder: $0.Route.create)
    ..hasRequiredFields = false
  ;
...
class SendToRouteResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SendToRouteResponse', package: const $pb.PackageName('routerrpc'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, 'preimage', $pb.PbFieldType.OY)
    ..a<Failure>(2, 'failure', $pb.PbFieldType.OM, defaultOrMaker: Failure.getDefault, subBuilder: Failure.create)
    ..hasRequiredFields = false
  ;
  ...
  SendToRouteResponse copyWith(void Function(SendToRouteResponse) updates) => super.copyWith((message) => updates(message as SendToRouteResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static SendToRouteResponse getDefault() => _defaultInstance ??= create()..freeze();
  ...
  set failure(Failure v) { setField(2, v); }
  $core.bool hasFailure() => $_has(1);
  void clearFailure() => clearField(2);
}

class Failure extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Failure', package: const $pb.PackageName('routerrpc'), createEmptyInstance: create)
    ...
    ..a<ChannelUpdate>(3, 'channelUpdate', $pb.PbFieldType.OM, defaultOrMaker: ChannelUpdate.getDefault, subBuilder: ChannelUpdate.create)
  ...
  set htlcMsat(Int64 v) { $_setInt64(2, v); }
...
class ChannelUpdate extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ChannelUpdate', package: const $pb.PackageName('routerrpc'), createEmptyInstance: create)
    ...
    ..a<Int64>(7, 'htlcMinimumMsat', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
    ...
    ..a<Int64>(11, 'htlcMaximumMsat', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
  ...
  set chanId(Int64 v) { $_setInt64(2, v); }
  ...
  set htlcMinimumMsat(Int64 v) { $_setInt64(6, v); }
  ...
  set htlcMaximumMsat(Int64 v) { $_setInt64(10, v); }
...
class ResetMissionControlRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResetMissionControlRequest', package: const $pb.PackageName('routerrpc'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  ResetMissionControlRequest copyWith(void Function(ResetMissionControlRequest) updates) => super.copyWith((message) => updates(message as ResetMissionControlRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static ResetMissionControlRequest getDefault() => _defaultInstance ??= create()..freeze();
  static ResetMissionControlRequest _defaultInstance;
}

class ResetMissionControlResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ResetMissionControlResponse', package: const $pb.PackageName('routerrpc'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  ResetMissionControlResponse copyWith(void Function(ResetMissionControlResponse) updates) => super.copyWith((message) => updates(message as ResetMissionControlResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static ResetMissionControlResponse getDefault() => _defaultInstance ??= create()..freeze();
  static ResetMissionControlResponse _defaultInstance;
}

class QueryMissionControlRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('QueryMissionControlRequest', package: const $pb.PackageName('routerrpc'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  QueryMissionControlRequest copyWith(void Function(QueryMissionControlRequest) updates) => super.copyWith((message) => updates(message as QueryMissionControlRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static QueryMissionControlRequest getDefault() => _defaultInstance ??= create()..freeze();
  static QueryMissionControlRequest _defaultInstance;
}

class QueryMissionControlResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('QueryMissionControlResponse', package: const $pb.PackageName('routerrpc'), createEmptyInstance: create)
    ..pc<PairHistory>(2, 'pairs', $pb.PbFieldType.PM, subBuilder: PairHistory.create)
    ..hasRequiredFields = false
  ;
  ...
  QueryMissionControlResponse copyWith(void Function(QueryMissionControlResponse) updates) => super.copyWith((message) => updates(message as QueryMissionControlResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static QueryMissionControlResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class PairHistory extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PairHistory', package: const $pb.PackageName('routerrpc'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, 'node_from', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(2, 'node_to', $pb.PbFieldType.OY)
    ..a<PairData>(7, 'history', $pb.PbFieldType.OM, defaultOrMaker: PairData.getDefault, subBuilder: PairData.create)
    ..hasRequiredFields = false
  ;
  ...
  PairHistory copyWith(void Function(PairHistory) updates) => super.copyWith((message) => updates(message as PairHistory));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PairData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PairData', package: const $pb.PackageName('routerrpc'), createEmptyInstance: create)
    ..aInt64(1, 'fail_time')
  ...
  PairData copyWith(void Function(PairData) updates) => super.copyWith((message) => updates(message as PairData));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class QueryProbabilityRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('QueryProbabilityRequest', package: const $pb.PackageName('routerrpc'), createEmptyInstance: create)
  ...
  QueryProbabilityRequest copyWith(void Function(QueryProbabilityRequest) updates) => super.copyWith((message) => updates(message as QueryProbabilityRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static QueryProbabilityRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class QueryProbabilityResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('QueryProbabilityResponse', package: const $pb.PackageName('routerrpc'), createEmptyInstance: create)
    ..a<$core.double>(1, 'probability', $pb.PbFieldType.OD)
    ..a<PairData>(2, 'history', $pb.PbFieldType.OM, defaultOrMaker: PairData.getDefault, subBuilder: PairData.create)
    ..hasRequiredFields = false
  ;
  ...
  QueryProbabilityResponse copyWith(void Function(QueryProbabilityResponse) updates) => super.copyWith((message) => updates(message as QueryProbabilityResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static QueryProbabilityResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class BuildRouteRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BuildRouteRequest', package: const $pb.PackageName('routerrpc'), createEmptyInstance: create)
    ..aInt64(1, 'amtMsat')
    ..a<$core.int>(2, 'finalCltvDelta', $pb.PbFieldType.O3)
    ..a<Int64>(3, 'outgoingChanId', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
  ...
  BuildRouteRequest copyWith(void Function(BuildRouteRequest) updates) => super.copyWith((message) => updates(message as BuildRouteRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static BuildRouteRequest getDefault() => _defaultInstance ??= create()..freeze();
  static BuildRouteRequest _defaultInstance;

  Int64 get amtMsat => $_getI64(0);
  set amtMsat(Int64 v) { $_setInt64(0, v); }
  ...
  set outgoingChanId(Int64 v) { $_setInt64(2, v); }
...
class BuildRouteResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BuildRouteResponse', package: const $pb.PackageName('routerrpc'), createEmptyInstance: create)
    ..a<$0.Route>(1, 'route', $pb.PbFieldType.OM, defaultOrMaker: $0.Route.getDefault, subBuilder: $0.Route.create)
    ..hasRequiredFields = false
  ;
  ...
  BuildRouteResponse copyWith(void Function(BuildRouteResponse) updates) => super.copyWith((message) => updates(message as BuildRouteResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static BuildRouteResponse getDefault() => _defaultInstance ??= create()..freeze();

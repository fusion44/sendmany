...
class InitWalletRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('InitWalletRequest', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ...
    ..a<ChanBackupSnapshot>(5, 'channelBackups', $pb.PbFieldType.OM, defaultOrMaker: ChanBackupSnapshot.getDefault, subBuilder: ChanBackupSnapshot.create)
    ..hasRequiredFields = false
  ;
...
class UnlockWalletRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UnlockWalletRequest', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ...
    ..a<ChanBackupSnapshot>(3, 'channelBackups', $pb.PbFieldType.OM, defaultOrMaker: ChanBackupSnapshot.getDefault, subBuilder: ChanBackupSnapshot.create)
    ..hasRequiredFields = false
  ;
...
class Utxo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Utxo', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..e<AddressType>(1, 'address_type', $pb.PbFieldType.OE, protoName: 'type', defaultOrMaker: AddressType.WITNESS_PUBKEY_HASH, valueOf: AddressType.valueOf, enumValues: AddressType.values)
    ..aOS(2, 'address')
    ..aInt64(3, 'amount_sat')
    ..aOS(4, 'pk_script')
    ..a<OutPoint>(5, 'outpoint', $pb.PbFieldType.OM, defaultOrMaker: OutPoint.getDefault, subBuilder: OutPoint.create)
...
class FeeLimit extends $pb.GeneratedMessage {
  ...
  set fixedMsat(Int64 v) { $_setInt64(2, v); }
...
class SendResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SendResponse', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ...
    ..a<Route>(3, 'payment_route', $pb.PbFieldType.OM, defaultOrMaker: Route.getDefault, subBuilder: Route.create)
...
class SendToRouteRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SendToRouteRequest', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ...
    ..a<Route>(4, 'route', $pb.PbFieldType.OM, defaultOrMaker: Route.getDefault, subBuilder: Route.create)
    ..hasRequiredFields = false
  ;
...
class ChannelAcceptRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ChannelAcceptRequest', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ...
    ..a<Int64>(7, 'maxValueInFlight', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
    ..a<Int64>(8, 'channelReserve', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
  ...
  static ChannelAcceptRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class ChannelAcceptResponse extends $pb.GeneratedMessage {
  ...
  static ChannelAcceptResponse getDefault() => _defaultInstance ??= create()..freeze();
...
class EstimateFeeRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EstimateFeeRequest', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..m<$core.String, Int64>(1, 'AddrToAmount', protoName: 'AddrToAmount', entryClassName: 'EstimateFeeRequest.AddrToAmountEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.O6, packageName: const $pb.PackageName('lnrpc'))
...
class SendManyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SendManyRequest', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..m<$core.String, Int64>(1, 'AddrToAmount', protoName: 'AddrToAmount', entryClassName: 'SendManyRequest.AddrToAmountEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.O6, packageName: const $pb.PackageName('lnrpc'))
...
class ConnectPeerRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ConnectPeerRequest', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..a<LightningAddress>(1, 'addr', $pb.PbFieldType.OM, defaultOrMaker: LightningAddress.getDefault, subBuilder: LightningAddress.create)
    ..aOB(2, 'perm')
    ..hasRequiredFields = false
  ;
...
class Channel extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Channel', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ...
    ..a<Int64>(14, 'num_updates', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
  ...
  set localChanReserveSat(Int64 v) { $_setInt64(19, v); }
  ...
  set remoteChanReserveSat(Int64 v) { $_setInt64(20, v); }
...
class ChannelCloseSummary extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ChannelCloseSummary', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ...
    ..e<ChannelCloseSummary_ClosureType>(10, 'close_type', $pb.PbFieldType.OE, defaultOrMaker: ChannelCloseSummary_ClosureType.COOPERATIVE_CLOSE, valueOf: ChannelCloseSummary_ClosureType.valueOf, enumValues: ChannelCloseSummary_ClosureType.values)
    ..hasRequiredFields = false
  ;
...
class ChannelOpenUpdate extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ChannelOpenUpdate', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..a<ChannelPoint>(1, 'channel_point', $pb.PbFieldType.OM, defaultOrMaker: ChannelPoint.getDefault, subBuilder: ChannelPoint.create)
    ..hasRequiredFields = false
  ;
...
class CloseChannelRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CloseChannelRequest', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..a<ChannelPoint>(1, 'channelPoint', $pb.PbFieldType.OM, defaultOrMaker: ChannelPoint.getDefault, subBuilder: ChannelPoint.create)
    ..aOB(2, 'force')
    ..a<$core.int>(3, 'targetConf', $pb.PbFieldType.O3)
    ..aInt64(4, 'satPerByte')
    ..hasRequiredFields = false
...
class CloseStatusUpdate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CloseStatusUpdate', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..oo(0, [1, 3])
    ..a<PendingUpdate>(1, 'close_pending', $pb.PbFieldType.OM, defaultOrMaker: PendingUpdate.getDefault, subBuilder: PendingUpdate.create)
    ..a<ChannelCloseUpdate>(3, 'chan_close', $pb.PbFieldType.OM, defaultOrMaker: ChannelCloseUpdate.getDefault, subBuilder: ChannelCloseUpdate.create)
    ..hasRequiredFields = false
  ;
...
class OpenStatusUpdate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OpenStatusUpdate', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..oo(0, [1, 3])
    ..a<PendingUpdate>(1, 'chan_pending', $pb.PbFieldType.OM, defaultOrMaker: PendingUpdate.getDefault, subBuilder: PendingUpdate.create)
    ..a<ChannelOpenUpdate>(3, 'chan_open', $pb.PbFieldType.OM, defaultOrMaker: ChannelOpenUpdate.getDefault, subBuilder: ChannelOpenUpdate.create)
    ..hasRequiredFields = false
  ;
...
class PendingChannelsResponse_PendingChannel extends $pb.GeneratedMessage {
  ...
  set localChanReserveSat(Int64 v) { $_setInt64(5, v); }
  ...
  set remoteChanReserveSat(Int64 v) { $_setInt64(6, v); }
...
class PendingChannelsResponse_PendingOpenChannel extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PendingChannelsResponse.PendingOpenChannel', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..a<PendingChannelsResponse_PendingChannel>(1, 'channel', $pb.PbFieldType.OM, defaultOrMaker: PendingChannelsResponse_PendingChannel.getDefault, subBuilder: PendingChannelsResponse_PendingChannel.create)
...
class PendingChannelsResponse_ForceClosedChannel extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PendingChannelsResponse.ForceClosedChannel', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ...
    ..pc<PendingHTLC>(8, 'pending_htlcs', $pb.PbFieldType.PM, subBuilder: PendingHTLC.create)
    ..hasRequiredFields = false
  ;
...
class PendingChannelsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PendingChannelsResponse', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ...
    ..pc<PendingChannelsResponse_PendingOpenChannel>(2, 'pending_open_channels', $pb.PbFieldType.PM, subBuilder: PendingChannelsResponse_PendingOpenChannel.create)
    ..pc<PendingChannelsResponse_ClosedChannel>(3, 'pending_closing_channels', $pb.PbFieldType.PM, subBuilder: PendingChannelsResponse_ClosedChannel.create)
    ..pc<PendingChannelsResponse_ForceClosedChannel>(4, 'pending_force_closing_channels', $pb.PbFieldType.PM, subBuilder: PendingChannelsResponse_ForceClosedChannel.create)
    ..pc<PendingChannelsResponse_WaitingCloseChannel>(5, 'waiting_close_channels', $pb.PbFieldType.PM, subBuilder: PendingChannelsResponse_WaitingCloseChannel.create)
    ..hasRequiredFields = false
  ;
...
class ChannelEventUpdate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ChannelEventUpdate', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4])
    ..a<Channel>(1, 'open_channel', $pb.PbFieldType.OM, defaultOrMaker: Channel.getDefault, subBuilder: Channel.create)
    ..a<ChannelCloseSummary>(2, 'closed_channel', $pb.PbFieldType.OM, defaultOrMaker: ChannelCloseSummary.getDefault, subBuilder: ChannelCloseSummary.create)
    ..a<ChannelPoint>(3, 'active_channel', $pb.PbFieldType.OM, defaultOrMaker: ChannelPoint.getDefault, subBuilder: ChannelPoint.create)
    ..a<ChannelPoint>(4, 'inactive_channel', $pb.PbFieldType.OM, defaultOrMaker: ChannelPoint.getDefault, subBuilder: ChannelPoint.create)
...
class QueryRoutesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('QueryRoutesRequest', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ...
    ..a<FeeLimit>(5, 'feeLimit', $pb.PbFieldType.OM, defaultOrMaker: FeeLimit.getDefault, subBuilder: FeeLimit.create)
...
class MPPRecord extends $pb.GeneratedMessage {
  ...
  set totalAmtMsat(Int64 v) { $_setInt64(0, v); }
...
class NodeInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NodeInfo', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..a<LightningNode>(1, 'node', $pb.PbFieldType.OM, defaultOrMaker: LightningNode.getDefault, subBuilder: LightningNode.create)
...
class ChannelEdge extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ChannelEdge', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ...
    ..aOS(5, 'node2_pub')
    ..aInt64(6, 'capacity')
    ..a<RoutingPolicy>(7, 'node1_policy', $pb.PbFieldType.OM, defaultOrMaker: RoutingPolicy.getDefault, subBuilder: RoutingPolicy.create)
    ..a<RoutingPolicy>(8, 'node2_policy', $pb.PbFieldType.OM, defaultOrMaker: RoutingPolicy.getDefault, subBuilder: RoutingPolicy.create)
    ..hasRequiredFields = false
  ;
...
class NetworkInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NetworkInfo', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ...
    ..a<Int64>(11, 'num_zombie_chans', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
    ..hasRequiredFields = false
  ;
  ...
  set numZombieChans(Int64 v) { $_setInt64(10, v); }
...
class ChannelEdgeUpdate extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ChannelEdgeUpdate', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..a<Int64>(1, 'chanId', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
    ..a<ChannelPoint>(2, 'chanPoint', $pb.PbFieldType.OM, defaultOrMaker: ChannelPoint.getDefault, subBuilder: ChannelPoint.create)
    ..aInt64(3, 'capacity')
    ..a<RoutingPolicy>(4, 'routingPolicy', $pb.PbFieldType.OM, defaultOrMaker: RoutingPolicy.getDefault, subBuilder: RoutingPolicy.create)
...
class ClosedChannelUpdate extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClosedChannelUpdate', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ...
    ..a<ChannelPoint>(4, 'chanPoint', $pb.PbFieldType.OM, defaultOrMaker: ChannelPoint.getDefault, subBuilder: ChannelPoint.create)
    ..hasRequiredFields = false
  ;
...
class RouteHint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RouteHint', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..pc<HopHint>(1, 'hop_hints', $pb.PbFieldType.PM, subBuilder: HopHint.create)
    ..hasRequiredFields = false
  ;
...
class Invoice extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Invoice', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ...
    ..a<Int64>(13, 'cltv_expiry', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
    ..pc<RouteHint>(14, 'route_hints', $pb.PbFieldType.PM, subBuilder: RouteHint.create)
    ..aOB(15, 'private')
    ..a<Int64>(16, 'add_index', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
    ..a<Int64>(17, 'settle_index', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
    ..aInt64(18, 'amt_paid')
  ...
  set value(Int64 v) { $_setInt64(3, v); }
  ...
  set expiry(Int64 v) { $_setInt64(9, v); }
  ...
  set cltvExpiry(Int64 v) { $_setInt64(11, v); }
  ...
  @$core.Deprecated('This field is deprecated.')
  set amtPaid(Int64 v) { $_setInt64(16, v); }
  @$core.Deprecated('This field is deprecated.')
...
class ListInvoiceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListInvoiceRequest', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..aOB(1, 'pending_only')
    ..a<Int64>(4, 'index_offset', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
    ..a<Int64>(5, 'num_max_invoices', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
    ..aOB(6, 'reversed')
    ..hasRequiredFields = false
  ;
...
class ListInvoiceResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListInvoiceResponse', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ...
    ..a<Int64>(2, 'last_index_offset', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
    ..a<Int64>(3, 'first_index_offset', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
    ..hasRequiredFields = false
  ;
...
class InvoiceSubscription extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('InvoiceSubscription', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ...
    ..a<Int64>(2, 'settle_index', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
    ..hasRequiredFields = false
  ;
...
class HTLCAttempt extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('HTLCAttempt', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ...
    ..a<Route>(2, 'route', $pb.PbFieldType.OM, defaultOrMaker: Route.getDefault, subBuilder: Route.create)
...
class FeeReportResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FeeReportResponse', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..pc<ChannelFeeReport>(1, 'channel_fees', $pb.PbFieldType.PM, subBuilder: ChannelFeeReport.create)
    ..a<Int64>(2, 'day_fee_sum', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
    ..a<Int64>(3, 'week_fee_sum', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
    ..a<Int64>(4, 'month_fee_sum', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
    ..hasRequiredFields = false
  ;
...
class PolicyUpdateRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PolicyUpdateRequest', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOB(1, 'global')
    ..a<ChannelPoint>(2, 'chan_point', $pb.PbFieldType.OM, defaultOrMaker: ChannelPoint.getDefault, subBuilder: ChannelPoint.create)
...
class ForwardingEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ForwardingEvent', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ...
    ..a<Int64>(4, 'chan_id_out', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
    ...
    ..a<Int64>(9, 'amt_in_msat', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
    ..a<Int64>(10, 'amt_out_msat', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
    ..hasRequiredFields = false
  ;
...
class ForwardingHistoryResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ForwardingHistoryResponse', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..pc<ForwardingEvent>(1, 'forwarding_events', $pb.PbFieldType.PM, subBuilder: ForwardingEvent.create)
...
class ExportChannelBackupRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ExportChannelBackupRequest', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..a<ChannelPoint>(1, 'chanPoint', $pb.PbFieldType.OM, defaultOrMaker: ChannelPoint.getDefault, subBuilder: ChannelPoint.create)
    ..hasRequiredFields = false
  ;
...
class ChannelBackup extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ChannelBackup', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..a<ChannelPoint>(1, 'chan_point', $pb.PbFieldType.OM, defaultOrMaker: ChannelPoint.getDefault, subBuilder: ChannelPoint.create)
...
class MultiChanBackup extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MultiChanBackup', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..pc<ChannelPoint>(1, 'chan_points', $pb.PbFieldType.PM, subBuilder: ChannelPoint.create)
...
class ChanBackupSnapshot extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ChanBackupSnapshot', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..a<ChannelBackups>(1, 'single_chan_backups', $pb.PbFieldType.OM, defaultOrMaker: ChannelBackups.getDefault, subBuilder: ChannelBackups.create)
    ..a<MultiChanBackup>(2, 'multi_chan_backup', $pb.PbFieldType.OM, defaultOrMaker: MultiChanBackup.getDefault, subBuilder: MultiChanBackup.create)
    ..hasRequiredFields = false
  ;
...
class ChannelBackups extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ChannelBackups', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..pc<ChannelBackup>(1, 'chan_backups', $pb.PbFieldType.PM, subBuilder: ChannelBackup.create)
    ..hasRequiredFields = false
  ;
...
class RestoreChanBackupRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RestoreChanBackupRequest', package: const $pb.PackageName('lnrpc'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..a<ChannelBackups>(1, 'chan_backups', $pb.PbFieldType.OM, defaultOrMaker: ChannelBackups.getDefault, subBuilder: ChannelBackups.create)
    ..a<$core.List<$core.int>>(2, 'multi_chan_backup', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
...
class MacaroonPermission extends $pb.GeneratedMessage {
  ...
  static MacaroonPermission getDefault() => _defaultInstance ??= create()..freeze();
...
class BakeMacaroonRequest extends $pb.GeneratedMessage {
  ...
  static BakeMacaroonRequest getDefault() => _defaultInstance ??= create()..freeze();
...
class BakeMacaroonResponse extends $pb.GeneratedMessage {
  ...
  static BakeMacaroonResponse getDefault() => _defaultInstance ??= create()..freeze();
